    ...
    <div className="flex flex-col gap-2 relative w-full">
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-full bg-[#09090b] border border-[#27272a] rounded-md text-xs py-2 pl-9 pr-3 text-white outline-none focus:border-red-500 transition-colors placeholder-zinc-700"
        />
      </div>
      ...
      <div className="p-5 grow overflow-y-auto flex flex-col gap-6 custom-scrollbar scrollbar-small">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="bg-[#09090b] border border-[#27272a] rounded-md text-xs p-2.5 text-white outline-none focus:border-red-500 transition-colors placeholder-zinc-700 shadow-inner"
            value={localComment}
            ...
            Object.entries(tool.parameters.properties).map(([key, prop]: any) => (
              <div key={key} className="flex flex-col gap-2 w-full">
                ...
                {key === 'app_name' && (tool.name === 'open_app' || tool.name === 'close_app') ? (
                  ...
                  <select
                    className="bg-[#09090b] border border-[#27272a] rounded-md text-xs p-2.5 text-white outline-none focus:border-red-500 transition-colors cursor-pointer w-full"
                    value={localInputs[key] || ''}
                  ...
                  <input
                    ...
                    className="bg-[#09090b] border border-[#27272a] rounded-md text-xs p-2.5 text-white outline-none focus:border-red-500 transition-colors placeholder-zinc-700 font-mono shadow-inner w-full"
                    value={localInputs[key] || ''}
                    onChange={(e) => handleInputChange(key, e.target.value)}
                  />
                )}
