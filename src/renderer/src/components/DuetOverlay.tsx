...
const DuetOverlay = (): React.JSX.Element | null => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-24 z-[9080] flex flex-col items-center pointer-events-none px-4">
      <div className="pointer-events-auto w-full max-w-2xl bg-black/80 backdrop-blur-xl border border-red-500/30 rounded-2xl shadow-[0_10px_60px_rgba(239,68,68,0.25)] overflow-hidden">
