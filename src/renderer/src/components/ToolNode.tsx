...
export default function ToolNode({ data, id }: any) {
  ...
  return (
    <div
      className="bg-[#18181b] border border-[#27272a] rounded-lg shadow-xl min-w-50 max-w-62.5 font-sans text-zinc-100 group transition-all hover:border-red-500/50 relative"
