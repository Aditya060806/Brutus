                ...
                },
                {
                  ...
                  parameters: {
                    ...
                    properties: {
                      emotion: {
                        type: 'STRING',
                        description: 'Eye emotion to set. One of: neutral, happy, angry, sad, sleepy, love. Do NOT use "surprised".'
                      },
                      gesture: {
                        type: 'STRING',
                        description: 'Optional gesture animation to trigger. One of: greetingWink, heartEyes, thinkingLookUpLeft, excitedDance, sadTearBlink, jokeLaugh, taskComplete, curiousTilt, shyLookAway, intimidationStare, deepFocus'
                      },
                      duration_ms: {
                        type: 'NUMBER',
                        description: 'How long the emotion should last in milliseconds (default 3000)'
                      }
                    },
                    required: ['emotion']
                  }
