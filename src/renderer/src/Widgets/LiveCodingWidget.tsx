...
export default function LiveCodingWidget() {
  ...
  return (
    <div className="absolute inset-0 z-999 flex items-center justify-center bg-black/60 backdrop-blur-sm p-10">
      <div className="w-full max-w-4xl h-[70vh] flex flex-col bg-canvas border border-red-500/30 rounded-xl shadow-[0_0_50px_rgba(var(--brutus-accent-c),0.1)] overflow-hidden">
        ...
        <div className="flex-1 relative pt-4 bg-canvas">
          <Editor
            height="100%"
