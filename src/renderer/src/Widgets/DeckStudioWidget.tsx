        ...
        <div className="flex-1 overflow-y-auto scrollbar-small p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-2 w-full bg-canvas border border-white/10 rounded-lg p-3.5 text-sm text-zinc-100 placeholder:text-zinc-600 resize-none outline-none focus:border-red-500/40 transition-colors disabled:opacity-50"
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                disabled={busy}
                placeholder="auto"
                className="w-20 bg-canvas border border-white/10 rounded-md px-2.5 py-1.5 text-sm text-zinc-100 outline-none focus:border-red-500/40 disabled:opacity-50"
              />
            </div>
            ...
            {qaOn && (
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  disabled={busy}
                  className="bg-canvas border border-white/10 rounded-md px-2 py-1.5 text-sm text-zinc-100 outline-none focus:border-red-500/40 disabled:opacity-50"
                >
