...
export default function WormholeWidget() {
  ...
  return (
    <div className="absolute inset-0 z-999 flex items-center justify-center bg-black/80 backdrop-blur-md animate-in fade-in duration-300 p-8">
      <div className="w-full max-w-3xl bg-canvas border border-red-500/30 rounded-2xl shadow-[0_0_80px_rgba(var(--brutus-accent-c),0.15)] overflow-hidden flex flex-col relative">
        <div className="h-14 bg-red-500/10 border-b border-red-500/20 flex items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-black tracking-[0.2em] text-red-400 uppercase">
              Cloudflare Wormhole
            </span>
          </div>
          <button
        ...
        <div className="p-8 md:p-10 flex flex-col md:flex-row items-start gap-10">
          ...
          <div className="flex-1 flex flex-col w-full min-w-0">
            ...
            <div className="mb-8 w-full">
              <span className="text-[10px] font-bold tracking-widest text-red-500 uppercase mb-2 block">
                Secure Public Route
              </span>
              <a
                href={url}
                target="_blank"
                rel="noreferrer"
                className="flex items-start justify-between gap-4 p-4 bg-black/50 border border-white/10 rounded-xl hover:border-red-500/50 transition-colors group cursor-pointer shadow-inner w-full"
              >
                <span className="text-sm font-mono text-red-300 break-all leading-relaxed">
                  {url}
                </span>
                <ExternalLink className="w-5 h-5 text-zinc-500 group-hover:text-red-400 shrink-0 mt-0.5" />
              </a>
            </div>

            <div className="flex items-center gap-3 mt-auto">
              <div className="w-2.5 h-2.5 rounded-full bg-red-500 animate-pulse shadow-[0_0_10px_rgba(var(--brutus-accent-c),0.8)]"></div>
