    ...
    <div className="fixed inset-0 z-9999 flex items-center justify-center bg-black/80 backdrop-blur-md p-8 animate-in fade-in duration-200">
      <AnimatePresence>
        <motion.div
          ...
          className="w-full max-w-3xl bg-canvas border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col relative"
        >
          <motion.div
          ...
          <div className="p-8 flex flex-col gap-8">
            <div className="flex items-center gap-3 bg-canvas border border-zinc-800 rounded-lg p-3">
            ...
            <div
              ref={terminalRef}
              className="bg-canvas border border-zinc-800 rounded-xl p-4 h-40 overflow-hidden relative font-mono text-[11px]"
            >
              {logStream.map((log, i) => (
                <motion.div
                  key={i + log}
