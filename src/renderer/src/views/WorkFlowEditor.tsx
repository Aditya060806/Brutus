  ...
  return (
    <div className="flex h-full w-full bg-[#09090b] relative overflow-hidden animate-in fade-in duration-300">
      ...
      >
        {isSidebarOpen && (
          <>
            <h2 className="text-[10px] font-black tracking-[0.2em] text-red-500 mb-6 flex items-center gap-2 border-b border-[#27272a] pb-2 uppercase">
              MODULE LIBRARY
            </h2>
              ...
              <div key={category} className="mb-6">
                ...
                <div className="flex flex-col gap-2">
                  {tools.map((tool: any) => (
                    <div
                      key={tool.name}
                      className="flex items-center gap-3 p-2 bg-[#18181b] border border-[#27272a] rounded-lg cursor-grab hover:border-red-500/50 hover:bg-[#27272a]/50 transition-all group"
                      draggable
                      onDragStart={(e) =>
      ...
      <button
        ...
        className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-[#111113] border border-[#27272a] border-l-0 p-2 rounded-r-lg text-zinc-600 hover:text-red-500 z-50 transition-colors"
      >
      ...
      >
        <div className="absolute top-4 left-4 z-10 flex items-center gap-3 shadow-2xl">
          <button
            onClick={resetCanvas}
            className="p-3 rounded-lg bg-[#18181b] border border-[#27272a] text-zinc-600 hover:text-red-500 hover:border-red-500/50 transition-colors cursor-pointer"
          ...
          <input
            ...
            className="bg-[#18181b] border border-[#27272a] px-4 py-2 rounded-lg text-sm text-white outline-none focus:border-red-500 font-bold tracking-wide w-64 shadow-inner"
          />

          <button
            onClick={runMacroManually}
            className="bg-[#18181b] hover:bg-[#27272a] text-red-400 px-5 py-2 rounded-lg text-[11px] font-black tracking-widest transition-all border border-[#27272a] hover:border-red-500/50 flex items-center gap-2 cursor-pointer shadow-lg"
          >
