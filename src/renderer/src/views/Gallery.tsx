    ...
    <div className="flex-1 bg-white/8 h-full p-8 animate-in fade-in zoom-in duration-500 flex flex-col overflow-hidden">
      <div className="flex items-center justify-between pb-6 border-b border-white/5 mb-6 shrink-0">
        <div className="flex items-center gap-3 text-zinc-100">
          <div className="p-2 bg-red-500/10 rounded-lg border border-red-500/20 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
            <RiImage2Line className="text-red-400" size={24} />
          </div>
          <div>
            <h2 className="text-sm font-bold tracking-[0.2em] text-zinc-200">VISUAL VAULT</h2>
            <p className="text-[10px] text-zinc-500 font-mono mt-0.5">GENERATED BY BRUTUS</p>
          </div>
        </div>

        <div className="text-[10px] font-mono text-red-300 bg-red-500/10 px-3 py-1.5 rounded border border-red-500/20 shadow-sm flex items-center gap-2">
            ...
            {visibleImages.map((img, index) => {
              ...
              return (
                <div
                  ...
                  className="group relative aspect-16/10 bg-zinc-900/50 rounded-xl border border-white/5 overflow-hidden hover:border-red-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-300 cursor-pointer"
                >
                  <img
                    src={img.url}
                    alt={img.displayName}
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-black via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-4 translate-y-2 group-hover:translate-y-0">
                    ...
                    <p className="text-[8px] text-red-400 font-mono mb-3 uppercase tracking-wider opacity-80">
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            ...
            >
              <div className="p-4 bg-white/5 group-hover:bg-red-500/20 text-zinc-400 group-hover:text-red-400 rounded-full transition-all border border-white/5 transform group-hover:-translate-x-1">
              ...
              <div className="absolute bottom-10 z-50 flex flex-col items-center gap-6">
                <div className="text-center px-4 py-2 bg-black/60 backdrop-blur-md rounded-xl border border-white/5">
                  ...
                  <p className="text-xs text-zinc-500 font-mono">
                    {new Date(selectedImage.createdAt).toLocaleString()} • GENERATED BY BRUTUS
                  </p>
                </div>
