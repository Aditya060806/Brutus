      ...
      const htmlCode = `
        ...
        <head>
          <style>
            ...
            #hud { position: absolute; top: 48px; left: 50%; transform: translateX(-50%); background: rgba(0,0,0,0.9); color: #f87171; padding: 12px 24px; border-radius: 99px; border: 1px solid rgba(52,211,153,0.4); box-shadow: 0 0 30px rgba(52,211,153,0.2); display: flex; align-items: center; gap: 12px; font-size: 13px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase; pointer-events: none; }
            #selection { position: absolute; border: 1px solid #f87171; background: rgba(52,211,153,0.1); box-shadow: 0 0 50px rgba(52,211,153,0.2); display: none; }
      ...
      const widgetHtml = `
        ...
        <head>
          <style>
            ...
            .drag-header .brand { font-size: 11px; font-weight: 900; letter-spacing: 0.2em; color: #f87171; display: flex; align-items: center; gap: 8px; }
            .drag-header .brand .dot { width: 6px; height: 6px; background: #f87171; border-radius: 50%; box-shadow: 0 0 10px #f87171; }
            ...
            .action-btn:hover { background: rgba(52,211,153,0.1); border-color: #f87171; color: #f87171; }
            ...
            .tab.active { color: #f87171; border-bottom: 2px solid #f87171; background: rgba(52,211,153,0.05); }
            ...
            .loader {
              ...
              border-top-color: #f87171; border-bottom-color: #f87171; animation: spin 1s cubic-bezier(0.68, -0.55, 0.265, 1.55) infinite;
            }
            @keyframes spin { 100% { transform: rotate(360deg); } }
            .loading-text { font-size: 12px; font-weight: bold; letter-spacing: 0.3em; color: #f87171; animation: pulse 1.5s infinite; }
